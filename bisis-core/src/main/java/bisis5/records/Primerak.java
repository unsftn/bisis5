...
/**
 * Predstavlja primerak knjige vezan za MARC zapis.
 */
...
public class Primerak implements Serializable {
  ...
  /** Kreira primerak sa datim podacima. */
  ...
  /**
   * Konstruise Primerak iz niza ciji elementi su naziv-propertija, vrednost-propertija, ...
   * @param properties Niz vrednosti
   */
  public Primerak(Object[] properties) {
    this();
  ...
  /** Proverava da li je bar jedna komponenta signature definisana.
   * @return true ako postoji bar jedna komponenta signature
   */
  @JsonIgnore
  ...
  /** Vraca printabilnu reprezentaciju primerka. */
