...
import bisis5.prefixes.PrefixMap;
...
public class DefaultPrefixMap implements PrefixMap {
  ...
  public List getSubfields(String prefix) {
    List list = (List)subfieldMap.get(prefix);
    if (list == null)
      return new ArrayList();
    else
      return list;
  ...
  private void addToMap(String prefix, String subfield) {
    ...
    List sfList = (List)subfieldMap.get(prefix);
    if(sfList == null) {
